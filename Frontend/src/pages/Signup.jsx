...
import { User, Mail, Lock, ArrowRight, Sparkles, LayoutDashboard } from "lucide-react";
        ...
        <div className="hidden md:flex w-1/2 bg-indigo-600 relative overflow-hidden flex-col justify-between p-12 text-white">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 text-lg leading-relaxed opacity-90">
              Create an account today and streamline your workflow like never before.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto w-full">
            ...
            {msg && (
              <motion.div
                ...
                className={`p-4 rounded-xl text-sm font-medium mb-6 flex items-center gap-2 border ${msg.includes("created")
                  ? "bg-green-50 text-green-600 border-green-100"
                  : "bg-red-50 text-red-600 border-red-100"
                  }`}
              >
                <div className={`w-1.5 h-1.5 rounded-full ${msg.includes("created") ? "bg-green-500" : "bg-red-500"
                  }`}></div>
                {msg}
              </motion.div>
            )}
